...
> **Fork note:** every option below is also accepted under the `plugin:virtual_desktops:` (underscore) category, which is the spelling the Lua config format produces. When both are set, the underscore variant wins.
